...
Сделай минимум: happy-path unit-тест на сервис и e2e-тест на ручку. Тестовые файлы — тоже до 300 строк; ожидаемые данные выноси в модуль данных, кейсы — в `parametrize`. Прогони `make check` и `make test-be`. Не коммить.
