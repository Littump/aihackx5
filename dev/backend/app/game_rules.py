...
FRAUD_HISTORY_WINDOW_DAYS = 7
FRAUD_BURST_SAME_STORE_MIN_RECEIPTS = 4
FRAUD_BURST_WINDOW_MIN = 60
FRAUD_DAILY_VOLUME_MIN_RECEIPTS = 6
FRAUD_SAME_POS_SHARE_MIN = 0.70
FRAUD_SAME_POS_MIN_SAMPLE = 5
FRAUD_FREQUENCY_SPIKE_MULTIPLIER = 4
FRAUD_RETURN_AFTER_REWARD_MAX_DAYS = 3
FRAUD_BASKET_MONOTONY_MIN_CONSECUTIVE = 3
FRAUD_BASKET_MONOTONY_AMOUNT_TOLERANCE = 0.05
FRAUD_BASKET_MONOTONY_LOOKBACK_RECEIPTS = 10

FRAUD_INSTANT_SIGNUP_MAX_MINUTES = 10
FRAUD_MIN_PURCHASE_PATTERN_MIN_INVITEES = 3
FRAUD_MIN_PURCHASE_PATTERN_MIN_RUB = 500
FRAUD_MIN_PURCHASE_PATTERN_MAX_RUB = 550
FRAUD_MIN_PURCHASE_PATTERN_LOOKBACK_RECEIPTS = 5
FRAUD_INVITE_BURST_MAX_PER_HOUR = 5
FRAUD_INVITE_BURST_WINDOW_MIN = 60
FRAUD_SAME_STORE_ZERO_ACTIVITY_DAYS = 14
...
SIMULATE_FRAUD_BURST_COUNT = 5
SIMULATE_FRAUD_BURST_AMOUNT = 100
SIMULATE_FRAUD_BURST_INTERVAL_MIN = 3
SIMULATE_FRAUD_BURST_CATEGORY = "grocery"
SIMULATE_FRAUD_BURST_POS_ID = "FRAUD-BURST-POS"
SIMULATE_DRAFT_ITEMS_MIN = 3
SIMULATE_DRAFT_ITEMS_MAX = 4
SIMULATE_DRAFT_PROMO_DISCOUNT = 0.20
SIMULATE_DRAFT_DEFAULT_PRICE = 150
