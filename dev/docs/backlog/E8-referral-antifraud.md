...
**Описание:** правила §12, `on_receipt` и `on_challenge_completed` возвращают новые коды, XP через `record_reward`. `GET /users/{id}/achievements` с русскими названиями из словаря в `service.py`.
