...
| FE-D01 | E15 | Токены дизайн-системы в `@theme static` + `shared/ui`: Card, Button, ProgressBar, Badge, StatusChip, ListRow, Skeleton, Tile | R | FE-001 | todo | |
...
| FE-D06 | E15 | League по макету: шапка со статами, зоны разделителями, строка «Вы», дом vs район | R | FE-D03 | todo | |
| FE-D07 | E15 | Referral по макету: QR и код, награды, лимит, приглашённые, легенда статусов | R | FE-D03 | todo | |
| FE-D08 | E15 | Состояния: скелетоны, ошибка, пусто, подсветка изменений после симуляции покупки | R | FE-D04, FE-D05, FE-D06, FE-D07 | todo | |
| FE-D09 | E15 | PM view по макету: широкая раскладка, плашка допущений, шкала антифрода с засечками | R | FE-D01, FE-D03 | todo | |
